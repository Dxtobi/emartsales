        ...
        <div className="w-full  ">
            <div className="w-full p-5">
                ...
                <form onSubmit={handleSubmit(onSubmitForm)}>
                    ...
                    <input className="p-3 bg-gray-100 rounded-md w-full outline-none mb-2" type='text'  {...register('password', { required: true })} placeholder="password" />

                    <button className="p-3 bg-gray-900 text-white rounded-md w-full outline-none mb-2" type="submit">Login</button>
